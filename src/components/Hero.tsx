  ...
  return (
    <section className="relative bg-gradient-to-br from-stone-50 via-amber-50 to-stone-100 py-20 md:py-32">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-maroon-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gold-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-6 text-sm text-stone-600 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-maroon-700" fill="currentColor" viewBox="0 0 20 20">
